...
import com.amalgamasimulation.warehouse.application.utils.CurrentLocale;
...
public class SplashHandler {
	...
	public void processAdditions(MApplication app, EModelService modelService, EPartService partService) {
		...
		partService.activate(partService.findPart("com.amalgamasimulation.warehouse.application.part.properties"));
		partService.activate(partService.findPart("com.amalgamasimulation.warehouse.application.part.errors"));
		partService.activate(partService.findPart("com.amalgamasimulation.warehouse.application.part.objects"));
