package com.amalgamasimulation.warehouse.application.graphicaleditor;
...
import com.amalgamasimulation.warehouse.application.graphicaleditor.handlers.CreateArcHandler;
import com.amalgamasimulation.warehouse.application.graphicaleditor.handlers.CreateObjectHandler;
...
public class GraphicalEditorModule extends com.amalgamasimulation.graphicaleditor.Module{
	...
	protected Class<? extends ContentPartFactory> getContentPartFactoryType() {
		return com.amalgamasimulation.warehouse.application.graphicaleditor.factories.ContentPartFactory.class;
	}
