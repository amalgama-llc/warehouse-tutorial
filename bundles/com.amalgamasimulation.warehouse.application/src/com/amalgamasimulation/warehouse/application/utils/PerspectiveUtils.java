...
public class PerspectiveUtils {
	 ...
	 */
	public static final String COMMAND_PARAMETER_NAME = "com.amalgamasimulation.warehouse.application.commandparameter.switchPerspective";
	
	public static final String MODE_MENU_ID = "com.amalgamasimulation.warehouse.application.menu.mode";
	
	private static final String PERSPECTIVE_STACK_ID = "com.amalgamasimulation.warehouse.application.perspectivestack.0";
	...
	public enum Perspective {
		EDITOR("com.amalgamasimulation.warehouse.application.perspective.editor", false, false),
		SIMULATION("com.amalgamasimulation.warehouse.application.perspective.simulation", true, true)
		;
