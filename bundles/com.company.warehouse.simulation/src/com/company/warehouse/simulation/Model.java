...
//                    .map(scenarioNode -> newPalletPosition(scenarioNode, direction == Direction.OUT))
	...
	// end::initializeForklifts[]

	// tag::makeAssignments[]
	// tag::makeAssignments-declaration[]
    private void makeAssignments() {
    	// end::makeAssignments-declaration[]
