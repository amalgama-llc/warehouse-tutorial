...
import com.amalgamasimulation.warehouse.simulation.PalletContainer;
...
public class Forklift extends GraphAgent<Node, Arc> {
     ...
     */
    @Override
    public void onDestinationReached(GraphAgentPosition<Node, Arc> node) {
    ...
    public void putStatsSlot(IEquipmentState state) {
        ...
        var newSlot = new EquipmentStatsSlot(engine, state, this);
